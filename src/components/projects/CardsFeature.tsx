...
function CardsFeatures({ number, title, description, lang1, lang2, lang3, link, link2, link3, button, button2, button3 }: CardProps) {
    return (
        <div className="relative">
            ...
            <div className="absolute top-0 left-0 h-projectCardHeight rounded-projectCardRadius w-projectCardWidth blur-md bg-gray-500 z-0">
            </div>
            <div className="absolute top-0 right-0 w-95 h-70 blur-lg rounded-projectCardRadius bg-gray-500 z-0">
