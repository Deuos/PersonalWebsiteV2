                ...
                <div className='flex text-white justify-center'>
                    <div className='w-navbarWidth max-lg:w-navbarWidthTablet'>
                        ...
                        <div className='flex w-contactButton mt-10 justify-start'>
                            ...
                            <button className="flex bg-transparent text-black mr-10 w-contactButtonWidth h-contactButtonHeight py-2 px-4 items-center justify-center bg-white rounded-customButton hover:border hover:bg-gray-600">
